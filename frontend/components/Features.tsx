        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="group relative bg-dark border border-white/10 rounded-2xl p-6 hover:border-primary/50 hover:bg-dark/50 transition-all duration-300 hover:shadow-xl hover:shadow-primary/10 hover:-translate-y-1"
            >
              {/* Icon */}
